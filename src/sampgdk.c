...
struct sampgdk_api
{
	...
	bool (SAMPGDK_CALL *sampgdk_ApplyActorAnimation)(int actorid, const char *animlib, const char *animname,
	                                                 float fDelta, bool loop, bool lockx, bool locky, bool freeze,
	                                                 int time);
	...
	int (SAMPGDK_CALL *sampgdk_CreateObject)(int modelid, float x, float y, float z, float rX, float rY, float rZ,
	                                         float DrawDistance);

	bool (SAMPGDK_CALL *sampgdk_AttachObjectToVehicle)(int objectid, int vehicleid, float fOffsetX, float fOffsetY,
	                                                   float fOffsetZ, float fRotX, float fRotY, float fRotZ);

	bool (SAMPGDK_CALL *sampgdk_AttachObjectToObject)(int objectid, int attachtoid, float fOffsetX, float fOffsetY,
	                                                  float fOffsetZ, float fRotX, float fRotY, float fRotZ,
	                                                  bool SyncRotation);

	bool (SAMPGDK_CALL *sampgdk_AttachObjectToPlayer)(int objectid, int playerid, float fOffsetX, float fOffsetY,
	                                                  float fOffsetZ, float fRotX, float fRotY, float fRotZ);
	...
	int (SAMPGDK_CALL *sampgdk_MoveObject)(int objectid, float X, float Y, float Z, float Speed, float RotX, float RotY,
	                                       float RotZ);
	...
	int (SAMPGDK_CALL *sampgdk_CreatePlayerObject)(int playerid, int modelid, float x, float y, float z, float rX,
	                                               float rY, float rZ, float DrawDistance);

	bool (SAMPGDK_CALL *sampgdk_AttachPlayerObjectToPlayer)(int objectplayer, int objectid, int attachplayer,
	                                                        float OffsetX, float OffsetY, float OffsetZ, float rX,
	                                                        float rY, float rZ);

	bool (SAMPGDK_CALL *sampgdk_AttachPlayerObjectToVehicle)(int playerid, int objectid, int vehicleid, float fOffsetX,
	                                                         float fOffsetY, float fOffsetZ, float fRotX, float fRotY,
	                                                         float RotZ);
	...
	int (SAMPGDK_CALL *sampgdk_MovePlayerObject)(int playerid, int objectid, float x, float y, float z, float Speed,
	...
	bool (SAMPGDK_CALL *sampgdk_SetObjectMaterial)(int objectid, int materialindex, int modelid, const char *txdname,
	                                               const char *texturename, int materialcolor);

	bool (SAMPGDK_CALL *sampgdk_SetPlayerObjectMaterial)(int playerid, int objectid, int materialindex, int modelid,
	                                                     const char *txdname, const char *texturename,
	                                                     int materialcolor);

	bool (SAMPGDK_CALL *sampgdk_SetObjectMaterialText)(int objectid, const char *text, int materialindex,
	                                                   int materialsize, const char *fontface, int fontsize, bool bold,
	                                                   int fontcolor, int backcolor, int textalignment);

	bool (SAMPGDK_CALL *sampgdk_SetPlayerObjectMaterialText)(int playerid, int objectid, const char *text,
	                                                         int materialindex, int materialsize, const char *fontface,
	                                                         int fontsize, bool bold, int fontcolor, int backcolor,
	                                                         int textalignment);

	bool (SAMPGDK_CALL *sampgdk_SetObjectsDefaultCameraCol)(bool disable);

	bool (SAMPGDK_CALL *sampgdk_SetSpawnInfo)(int playerid, int team, int skin, float x, float y, float z,
	...
	bool (SAMPGDK_CALL *sampgdk_PlayAudioStreamForPlayer)(int playerid, const char *url, float posX, float posY,
	                                                      float posZ, float distance, bool usepos);
	...
	bool (SAMPGDK_CALL *sampgdk_RemoveBuildingForPlayer)(int playerid, int modelid, float fX, float fY, float fZ,
	                                                     float fRadius);

	bool (SAMPGDK_CALL *sampgdk_GetPlayerLastShotVectors)(int playerid, float *fOriginX, float *fOriginY,
	                                                      float *fOriginZ, float *fHitPosX, float *fHitPosY,
	                                                      float *fHitPosZ);

	bool (SAMPGDK_CALL *sampgdk_SetPlayerAttachedObject)(int playerid, int index, int modelid, int bone, float fOffsetX,
	                                                     float fOffsetY, float fOffsetZ, float fRotX, float fRotY,
	...
	bool (SAMPGDK_CALL *sampgdk_PlayerTextDrawSetPreviewRot)(int playerid, int text, float fRotX, float fRotY,
	...
	bool (SAMPGDK_CALL *sampgdk_SetPlayerChatBubble)(int playerid, const char *text, int color, float drawdistance,
	                                                 int expiretime);
	...
	bool (SAMPGDK_CALL *sampgdk_ApplyAnimation)(int playerid, const char *animlib, const char *animname, float fDelta,
	...
	bool (SAMPGDK_CALL *sampgdk_GetAnimationName)(int index, char *animlib, int animlib_size, char *animname,
	                                              int animname_size);
	...
	bool (SAMPGDK_CALL *sampgdk_SetPlayerRaceCheckpoint)(int playerid, int type, float x, float y, float z, float nextx,
	...
	bool (SAMPGDK_CALL *sampgdk_SetPlayerMapIcon)(int playerid, int iconid, float x, float y, float z, int markertype,
	                                              int color, int style);
	...
	bool (SAMPGDK_CALL *sampgdk_InterpolateCameraPos)(int playerid, float FromX, float FromY, float FromZ, float ToX,
	                                                  float ToY, float ToZ, int time, int cut);

	bool (SAMPGDK_CALL *sampgdk_InterpolateCameraLookAt)(int playerid, float FromX, float FromY, float FromZ, float ToX,
	                                                     float ToY, float ToZ, int time, int cut);
	...
	bool (SAMPGDK_CALL *sampgdk_CreateExplosionForPlayer)(int playerid, float X, float Y, float Z, int type,
	                                                      float Radius);
	...
	bool (SAMPGDK_CALL *sampgdk_SHA256_PassHash)(const char *password, const char *salt, char *ret_hash,
	                                             int ret_hash_len);
	...
	int (SAMPGDK_CALL *sampgdk_AddPlayerClass)(int modelid, float spawn_x, float spawn_y, float spawn_z, float z_angle,
	                                           int weapon1, int weapon1_ammo, int weapon2, int weapon2_ammo,
	                                           int weapon3, int weapon3_ammo);

	int (SAMPGDK_CALL *sampgdk_AddPlayerClassEx)(int teamid, int modelid, float spawn_x, float spawn_y, float spawn_z,
	                                             float z_angle, int weapon1, int weapon1_ammo, int weapon2,
	                                             int weapon2_ammo, int weapon3, int weapon3_ammo);

	int (SAMPGDK_CALL *sampgdk_AddStaticVehicle)(int modelid, float spawn_x, float spawn_y, float spawn_z,
	                                             float z_angle, int color1, int color2);

	int (SAMPGDK_CALL *sampgdk_AddStaticVehicleEx)(int modelid, float spawn_x, float spawn_y, float spawn_z,
	...
	int (SAMPGDK_CALL *sampgdk_CreateMenu)(const char *title, int columns, float x, float y, float col1width,
	                                       float col2width);
	...
	int (SAMPGDK_CALL *sampgdk_Create3DTextLabel)(const char *text, int color, float x, float y, float z,
	                                              float DrawDistance, int virtualworld, bool testLOS);

	bool (SAMPGDK_CALL *sampgdk_Delete3DTextLabel)(int id);

	bool (SAMPGDK_CALL *sampgdk_Attach3DTextLabelToPlayer)(int id, int playerid, float OffsetX, float OffsetY,
	                                                       float OffsetZ);

	bool (SAMPGDK_CALL *sampgdk_Attach3DTextLabelToVehicle)(int id, int vehicleid, float OffsetX, float OffsetY,
	                                                        float OffsetZ);

	bool (SAMPGDK_CALL *sampgdk_Update3DTextLabelText)(int id, int color, const char *text);

	int (SAMPGDK_CALL *sampgdk_CreatePlayer3DTextLabel)(int playerid, const char *text, int color, float x, float y,
	                                                    float z, float DrawDistance, int attachedplayer,
	...
	bool (SAMPGDK_CALL *sampgdk_ShowPlayerDialog)(int playerid, int dialogid, int style, const char *caption,
	...
	int (SAMPGDK_CALL *sampgdk_CreateVehicle)(int vehicletype, float x, float y, float z, float rotation, int color1,
	                                          int color2, int respawn_delay, bool addsiren);
	...
	bool (SAMPGDK_CALL *sampgdk_SetVehicleParamsEx)(int vehicleid, int engine, int lights, int alarm, int doors,
	                                                int bonnet, int boot, int objective);

	bool (SAMPGDK_CALL *sampgdk_GetVehicleParamsEx)(int vehicleid, int *engine, int *lights, int *alarm, int *doors,
	                                                int *bonnet, int *boot, int *objective);

	int (SAMPGDK_CALL *sampgdk_GetVehicleParamsSirenState)(int vehicleid);

	bool (SAMPGDK_CALL *sampgdk_SetVehicleParamsCarDoors)(int vehicleid, int driver, int passenger, int backleft,
	                                                      int backright);

	bool (SAMPGDK_CALL *sampgdk_GetVehicleParamsCarDoors)(int vehicleid, int *driver, int *passenger, int *backleft,
	                                                      int *backright);

	bool (SAMPGDK_CALL *sampgdk_SetVehicleParamsCarWindows)(int vehicleid, int driver, int passenger, int backleft,
	                                                        int backright);

	bool (SAMPGDK_CALL *sampgdk_GetVehicleParamsCarWindows)(int vehicleid, int *driver, int *passenger, int *backleft,
	                                                        int *backright);
	...
	bool (SAMPGDK_CALL *sampgdk_GetVehicleDamageStatus)(int vehicleid, int *panels, int *doors, int *lights,
	                                                    int *tires);
...
SAMPGDK_API(const AMX_NATIVE_INFO *, sampgdk_GetNatives(
		int *number))
{
	return sampgdk_native_get_natives(number);
}

SAMPGDK_API(AMX_NATIVE, sampgdk_FindNative(
		const char *name))
{
	if (name != NULL)
	{
...
SAMPGDK_API(cell, sampgdk_CallNative(AMX_NATIVE
		native, cell * params))
{
	return sampgdk_native_call(native, params);
}

SAMPGDK_API(cell, sampgdk_InvokeNative(AMX_NATIVE
		native,
		const char *format, ...))
{
	cell retval;
...
SAMPGDK_API(cell, sampgdk_InvokeNativeV(AMX_NATIVE
		native,
...
SAMPGDK_API(cell, sampgdk_InvokeNativeArray(AMX_NATIVE
		native,
		const char *format,
		void **args))
{
...
SAMPGDK_API(int, sampgdk_GetVersion(
		void))
{
	return SAMPGDK_VERSION_ID;
}

SAMPGDK_API(const char *, sampgdk_GetVersionString(
		void))
{
...
SAMPGDK_API(unsigned int, sampgdk_Supports(
		void))
{
	return SUPPORTS_VERSION;
}

SAMPGDK_API(bool, sampgdk_Load(
		void **ppData, sampgdk_hidden_t
		hidden))
{
...
SAMPGDK_API(void, sampgdk_logprintf(
		const char *format, ...))
{
	va_list args;
	va_start(args, format);
...
SAMPGDK_API(void, sampgdk_vlogprintf(
		const char *format, va_list
		args))
{
	sampgdk_do_vlogprintf(format, args);
...
SAMPGDK_NATIVE(bool, SetSpawnInfo(
		int playerid,
		int team,
		int skin,
		float x,
		...
		int weapon3_ammo))
{
	...
	cell retval;
	cell params[14];
	sampgdk_log_debug("SetSpawnInfo(%d, %d, %d, %f, %f, %f, %f, %d, %d, %d, %d, %d, %d)", playerid, team, skin, x, y, z,
	                  rotation, weapon1, weapon1_ammo, weapon2, weapon2_ammo, weapon3, weapon3_ammo);
...
SAMPGDK_NATIVE(bool, SpawnPlayer(
		int playerid))
{
	static AMX_NATIVE native;
	cell retval;
...
SAMPGDK_NATIVE(bool, SetPlayerPos(
		int playerid,
		float x,
		float y,
		float z))
...
SAMPGDK_NATIVE(bool, SetPlayerPosFindZ(
		int playerid,
		float x,
		float y,
		float z))
...
SAMPGDK_NATIVE(bool, GetPlayerPos(
		int playerid,
		float *x,
		float *y,
		float *z))
...
SAMPGDK_NATIVE(bool, SetPlayerFacingAngle(
		int playerid,
		float angle))
{
	static AMX_NATIVE native;
...
SAMPGDK_NATIVE(bool, GetPlayerFacingAngle(
		int playerid,
		float *angle))
{
	static AMX_NATIVE native;
...
SAMPGDK_NATIVE(bool, IsPlayerInRangeOfPoint(
		int playerid,
		float range,
		float x,
		float y,
...
SAMPGDK_NATIVE(float, GetPlayerDistanceFromPoint(
		int playerid,
		float x,
		float y,
		float z))
...
SAMPGDK_NATIVE(bool, IsPlayerStreamedIn(
		int playerid,
		int forplayerid))
{
	static AMX_NATIVE native;
...
SAMPGDK_NATIVE(bool, SetPlayerInterior(
		int playerid,
		int interiorid))
{
	static AMX_NATIVE native;
...
SAMPGDK_NATIVE(int, GetPlayerInterior(
		int playerid))
{
	static AMX_NATIVE native;
	cell retval;
...
SAMPGDK_NATIVE(bool, SetPlayerHealth(
		int playerid,
		float health))
{
	static AMX_NATIVE native;
...
SAMPGDK_NATIVE(bool, GetPlayerHealth(
		int playerid,
		float *health))
{
	static AMX_NATIVE native;
...
SAMPGDK_NATIVE(bool, SetPlayerArmour(
		int playerid,
		float armour))
{
	static AMX_NATIVE native;
...
SAMPGDK_NATIVE(bool, GetPlayerArmour(
		int playerid,
		float *armour))
{
	static AMX_NATIVE native;
...
SAMPGDK_NATIVE(bool, SetPlayerAmmo(
		int playerid,
		int weaponid,
		int ammo))
{
...
SAMPGDK_NATIVE(int, GetPlayerAmmo(
		int playerid))
{
	static AMX_NATIVE native;
	cell retval;
...
SAMPGDK_NATIVE(int, GetPlayerWeaponState(
		int playerid))
{
	static AMX_NATIVE native;
	cell retval;
...
SAMPGDK_NATIVE(int, GetPlayerTargetPlayer(
		int playerid))
{
	static AMX_NATIVE native;
	cell retval;
...
SAMPGDK_NATIVE(int, GetPlayerTargetActor(
		int playerid))
{
	static AMX_NATIVE native;
	cell retval;
...
SAMPGDK_NATIVE(bool, SetPlayerTeam(
		int playerid,
		int teamid))
{
	static AMX_NATIVE native;
...
SAMPGDK_NATIVE(int, GetPlayerTeam(
		int playerid))
{
	static AMX_NATIVE native;
	cell retval;
...
SAMPGDK_NATIVE(bool, SetPlayerScore(
		int playerid,
		int score))
{
	static AMX_NATIVE native;
...
SAMPGDK_NATIVE(int, GetPlayerScore(
		int playerid))
{
	static AMX_NATIVE native;
	cell retval;
...
SAMPGDK_NATIVE(int, GetPlayerDrunkLevel(
		int playerid))
{
	static AMX_NATIVE native;
	cell retval;
...
SAMPGDK_NATIVE(bool, SetPlayerDrunkLevel(
		int playerid,
		int level))
{
	static AMX_NATIVE native;
...
SAMPGDK_NATIVE(bool, SetPlayerColor(
		int playerid,
		int color))
{
	static AMX_NATIVE native;
...
SAMPGDK_NATIVE(int, GetPlayerColor(
		int playerid))
{
	static AMX_NATIVE native;
	cell retval;
...
SAMPGDK_NATIVE(bool, SetPlayerSkin(
		int playerid,
		int skinid))
{
	static AMX_NATIVE native;
...
SAMPGDK_NATIVE(int, GetPlayerSkin(
		int playerid))
{
	static AMX_NATIVE native;
	cell retval;
...
SAMPGDK_NATIVE(bool, GivePlayerWeapon(
		int playerid,
		int weaponid,
		int ammo))
{
...
SAMPGDK_NATIVE(bool, ResetPlayerWeapons(
		int playerid))
{
	static AMX_NATIVE native;
	cell retval;
...
SAMPGDK_NATIVE(bool, SetPlayerArmedWeapon(
		int playerid,
		int weaponid))
{
	static AMX_NATIVE native;
...
SAMPGDK_NATIVE(bool, GetPlayerWeaponData(
		int playerid,
		int slot,
		int *weapon,
		int *ammo))
...
SAMPGDK_NATIVE(bool, GivePlayerMoney(
		int playerid,
		int money))
{
	static AMX_NATIVE native;
...
SAMPGDK_NATIVE(bool, ResetPlayerMoney(
		int playerid))
{
	static AMX_NATIVE native;
	cell retval;
...
SAMPGDK_NATIVE(int, SetPlayerName(
		int playerid,
		const char *name))
{
	static AMX_NATIVE native;
...
SAMPGDK_NATIVE(int, GetPlayerMoney(
		int playerid))
{
	static AMX_NATIVE native;
	cell retval;
...
SAMPGDK_NATIVE(int, GetPlayerState(
		int playerid))
{
	static AMX_NATIVE native;
	cell retval;
...
SAMPGDK_NATIVE(bool, GetPlayerIp(
		int playerid,
		char *ip,
		int size))
{
...
SAMPGDK_NATIVE(int, GetPlayerPing(
		int playerid))
{
	static AMX_NATIVE native;
	cell retval;
...
SAMPGDK_NATIVE(int, GetPlayerWeapon(
		int playerid))
{
	static AMX_NATIVE native;
	cell retval;
...
SAMPGDK_NATIVE(bool, GetPlayerKeys(
		int playerid,
		int *keys,
		int *updown,
		int *leftright))
...
SAMPGDK_NATIVE(int, GetPlayerName(
		int playerid,
		char *name,
		int size))
{
...
SAMPGDK_NATIVE(bool, SetPlayerTime(
		int playerid,
		int hour,
		int minute))
{
...
SAMPGDK_NATIVE(bool, GetPlayerTime(
		int playerid,
		int *hour,
		int *minute))
{
...
SAMPGDK_NATIVE(bool, TogglePlayerClock(
		int playerid, bool
		toggle))
{
	static AMX_NATIVE native;
...
SAMPGDK_NATIVE(bool, SetPlayerWeather(
		int playerid,
		int weather))
{
	static AMX_NATIVE native;
...
SAMPGDK_NATIVE(bool, ForceClassSelection(
		int playerid))
{
	static AMX_NATIVE native;
	cell retval;
...
SAMPGDK_NATIVE(bool, SetPlayerWantedLevel(
		int playerid,
		int level))
{
	static AMX_NATIVE native;
...
SAMPGDK_NATIVE(int, GetPlayerWantedLevel(
		int playerid))
{
	static AMX_NATIVE native;
	cell retval;
...
SAMPGDK_NATIVE(bool, SetPlayerFightingStyle(
		int playerid,
		int style))
{
	static AMX_NATIVE native;
...
SAMPGDK_NATIVE(int, GetPlayerFightingStyle(
		int playerid))
{
	static AMX_NATIVE native;
	cell retval;
...
SAMPGDK_NATIVE(bool, SetPlayerVelocity(
		int playerid,
		float x,
		float y,
		float z))
...
SAMPGDK_NATIVE(bool, GetPlayerVelocity(
		int playerid,
		float *x,
		float *y,
		float *z))
...
SAMPGDK_NATIVE(bool, PlayCrimeReportForPlayer(
		int playerid,
		int suspectid,
		int crime))
{
...
SAMPGDK_NATIVE(bool, PlayAudioStreamForPlayer(
		int playerid,
		const char *url,
		float posX,
		float posY,
		...
		usepos))
{
	...
	cell params[8];
	cell url_;
	sampgdk_log_debug("PlayAudioStreamForPlayer(%d, \"%s\", %f, %f, %f, %f, %d)", playerid, url, posX, posY, posZ,
	                  distance, usepos);
...
SAMPGDK_NATIVE(bool, StopAudioStreamForPlayer(
		int playerid))
{
	static AMX_NATIVE native;
	cell retval;
...
SAMPGDK_NATIVE(bool, SetPlayerShopName(
		int playerid,
		const char *shopname))
{
	static AMX_NATIVE native;
...
SAMPGDK_NATIVE(bool, SetPlayerSkillLevel(
		int playerid,
		int skill,
		int level))
{
...
SAMPGDK_NATIVE(int, GetPlayerSurfingVehicleID(
		int playerid))
{
	static AMX_NATIVE native;
	cell retval;
...
SAMPGDK_NATIVE(int, GetPlayerSurfingObjectID(
		int playerid))
{
	static AMX_NATIVE native;
	cell retval;
...
SAMPGDK_NATIVE(bool, RemoveBuildingForPlayer(
		int playerid,
		int modelid,
		float fX,
		float fY,
...
SAMPGDK_NATIVE(bool, GetPlayerLastShotVectors(
		int playerid,
		float *fOriginX,
		float *fOriginY,
		float *fOriginZ,
		...
		float *fHitPosZ))
{
	...
	cell fHitPosY_;
	cell fHitPosZ_;
	sampgdk_log_debug("GetPlayerLastShotVectors(%d, %f, %f, %f, %f, %f, %f)", playerid, fOriginX, fOriginY, fOriginZ,
...
SAMPGDK_NATIVE(bool, SetPlayerAttachedObject(
		int playerid,
		int index,
		int modelid,
		int bone,
		...
		int materialcolor2))
{
	...
	cell retval;
	cell params[16];
	sampgdk_log_debug("SetPlayerAttachedObject(%d, %d, %d, %d, %f, %f, %f, %f, %f, %f, %f, %f, %f, %d, %d)", playerid,
	                  index, modelid, bone, fOffsetX, fOffsetY, fOffsetZ, fRotX, fRotY, fRotZ, fScaleX, fScaleY,
	                  fScaleZ, materialcolor1, materialcolor2);
...
SAMPGDK_NATIVE(bool, RemovePlayerAttachedObject(
		int playerid,
		int index))
{
	static AMX_NATIVE native;
...
SAMPGDK_NATIVE(bool, IsPlayerAttachedObjectSlotUsed(
		int playerid,
		int index))
{
	static AMX_NATIVE native;
...
SAMPGDK_NATIVE(bool, EditAttachedObject(
		int playerid,
		int index))
{
	static AMX_NATIVE native;
...
SAMPGDK_NATIVE(int, CreatePlayerTextDraw(
		int playerid,
		float x,
		float y,
		const char *text))
...
SAMPGDK_NATIVE(bool, PlayerTextDrawDestroy(
		int playerid,
		int text))
{
	static AMX_NATIVE native;
...
SAMPGDK_NATIVE(bool, PlayerTextDrawLetterSize(
		int playerid,
		int text,
		float x,
		float y))
...
SAMPGDK_NATIVE(bool, PlayerTextDrawTextSize(
		int playerid,
		int text,
		float x,
		float y))
...
SAMPGDK_NATIVE(bool, PlayerTextDrawAlignment(
		int playerid,
		int text,
		int alignment))
{
...
SAMPGDK_NATIVE(bool, PlayerTextDrawColor(
		int playerid,
		int text,
		int color))
{
...
SAMPGDK_NATIVE(bool, PlayerTextDrawUseBox(
		int playerid,
		int text, bool
		use))
{
...
SAMPGDK_NATIVE(bool, PlayerTextDrawBoxColor(
		int playerid,
		int text,
		int color))
{
...
SAMPGDK_NATIVE(bool, PlayerTextDrawSetShadow(
		int playerid,
		int text,
		int size))
{
...
SAMPGDK_NATIVE(bool, PlayerTextDrawSetOutline(
		int playerid,
		int text,
		int size))
{
...
SAMPGDK_NATIVE(bool, PlayerTextDrawBackgroundColor(
		int playerid,
		int text,
		int color))
{
...
SAMPGDK_NATIVE(bool, PlayerTextDrawFont(
		int playerid,
		int text,
		int font))
{
...
SAMPGDK_NATIVE(bool, PlayerTextDrawSetProportional(
		int playerid,
		int text, bool
		set))
{
...
SAMPGDK_NATIVE(bool, PlayerTextDrawSetSelectable(
		int playerid,
		int text, bool
		set))
{
...
SAMPGDK_NATIVE(bool, PlayerTextDrawShow(
		int playerid,
		int text))
{
	static AMX_NATIVE native;
...
SAMPGDK_NATIVE(bool, PlayerTextDrawHide(
		int playerid,
		int text))
{
	static AMX_NATIVE native;
...
SAMPGDK_NATIVE(bool, PlayerTextDrawSetString(
		int playerid,
		int text,
		const char *string))
{
...
SAMPGDK_NATIVE(bool, PlayerTextDrawSetPreviewModel(
		int playerid,
		int text,
		int modelindex))
{
...
SAMPGDK_NATIVE(bool, PlayerTextDrawSetPreviewRot(
		int playerid,
		int text,
		float fRotX,
		float fRotY,
		...
		float fZoom))
{
	...
	cell retval;
	cell params[7];
	sampgdk_log_debug("PlayerTextDrawSetPreviewRot(%d, %d, %f, %f, %f, %f)", playerid, text, fRotX, fRotY, fRotZ,
	                  fZoom);
...
SAMPGDK_NATIVE(bool, PlayerTextDrawSetPreviewVehCol(
		int playerid,
		int text,
		int color1,
		int color2))
...
SAMPGDK_NATIVE(bool, SetPVarInt(
		int playerid,
		const char *varname,
		int value))
{
...
SAMPGDK_NATIVE(bool, SetPVarString(
		int playerid,
		const char *varname,
		const char *value))
{
...
SAMPGDK_NATIVE(bool, GetPVarString(
		int playerid,
		const char *varname,
		char *value,
		int size))
...
SAMPGDK_NATIVE(bool, SetPVarFloat(
		int playerid,
		const char *varname,
		float value))
{
...
SAMPGDK_NATIVE(float, GetPVarFloat(
		int playerid,
		const char *varname))
{
	static AMX_NATIVE native;
...
SAMPGDK_NATIVE(bool, DeletePVar(
		int playerid,
		const char *varname))
{
	static AMX_NATIVE native;
...
SAMPGDK_NATIVE(int, GetPVarsUpperIndex(
		int playerid))
{
	static AMX_NATIVE native;
	cell retval;
...
SAMPGDK_NATIVE(bool, GetPVarNameAtIndex(
		int playerid,
		int index,
		char *varname,
		int size))
...
SAMPGDK_NATIVE(int, GetPVarType(
		int playerid,
		const char *varname))
{
	static AMX_NATIVE native;
...
SAMPGDK_NATIVE(bool, SetPlayerChatBubble(
		int playerid,
		const char *text,
		int color,
		float drawdistance,
...
SAMPGDK_NATIVE(bool, PutPlayerInVehicle(
		int playerid,
		int vehicleid,
		int seatid))
{
...
SAMPGDK_NATIVE(int, GetPlayerVehicleID(
		int playerid))
{
	static AMX_NATIVE native;
	cell retval;
...
SAMPGDK_NATIVE(int, GetPlayerVehicleSeat(
		int playerid))
{
	static AMX_NATIVE native;
	cell retval;
...
SAMPGDK_NATIVE(bool, RemovePlayerFromVehicle(
		int playerid))
{
	static AMX_NATIVE native;
	cell retval;
...
SAMPGDK_NATIVE(bool, TogglePlayerControllable(
		int playerid, bool
		toggle))
{
	static AMX_NATIVE native;
...
SAMPGDK_NATIVE(bool, PlayerPlaySound(
		int playerid,
		int soundid,
		float x,
		float y,
...
SAMPGDK_NATIVE(bool, ApplyAnimation(
		int playerid,
		const char *animlib,
		const char *animname,
		float fDelta, bool
		...
		forcesync))
{
	...
	cell animlib_;
	cell animname_;
	sampgdk_log_debug("ApplyAnimation(%d, \"%s\", \"%s\", %f, %d, %d, %d, %d, %d, %d)", playerid, animlib, animname,
	                  fDelta, loop, lockx, locky, freeze, time, forcesync);
...
SAMPGDK_NATIVE(bool, ClearAnimations(
		int playerid, bool
		forcesync))
{
	static AMX_NATIVE native;
...
SAMPGDK_NATIVE(int, GetPlayerAnimationIndex(
		int playerid))
{
	static AMX_NATIVE native;
	cell retval;
...
SAMPGDK_NATIVE(bool, GetAnimationName(
		int index,
		char *animlib,
		int animlib_size,
		char *animname,
		int animname_size))
{
	...
	cell animlib_;
	cell animname_;
	sampgdk_log_debug("GetAnimationName(%d, \"%s\", %d, \"%s\", %d)", index, animlib, animlib_size, animname,
	                  animname_size);
...
SAMPGDK_NATIVE(int, GetPlayerSpecialAction(
		int playerid))
{
	static AMX_NATIVE native;
	cell retval;
...
SAMPGDK_NATIVE(bool, SetPlayerSpecialAction(
		int playerid,
		int actionid))
{
	static AMX_NATIVE native;
...
SAMPGDK_NATIVE(bool, DisableRemoteVehicleCollisions(
		int playerid, bool
		disable))
{
	static AMX_NATIVE native;
...
SAMPGDK_NATIVE(bool, SetPlayerCheckpoint(
		int playerid,
		float x,
		float y,
		float z,
...
SAMPGDK_NATIVE(bool, DisablePlayerCheckpoint(
		int playerid))
{
	static AMX_NATIVE native;
	cell retval;
...
SAMPGDK_NATIVE(bool, SetPlayerRaceCheckpoint(
		int playerid,
		int type,
		float x,
		float y,
		...
		float size))
{
	...
	cell retval;
	cell params[10];
	sampgdk_log_debug("SetPlayerRaceCheckpoint(%d, %d, %f, %f, %f, %f, %f, %f, %f)", playerid, type, x, y, z, nextx,
	                  nexty, nextz, size);
...
SAMPGDK_NATIVE(bool, DisablePlayerRaceCheckpoint(
		int playerid))
{
	static AMX_NATIVE native;
	cell retval;
...
SAMPGDK_NATIVE(bool, SetPlayerWorldBounds(
		int playerid,
		float x_max,
		float x_min,
		float y_max,
...
SAMPGDK_NATIVE(bool, SetPlayerMarkerForPlayer(
		int playerid,
		int showplayerid,
		int color))
{
...
SAMPGDK_NATIVE(bool, ShowPlayerNameTagForPlayer(
		int playerid,
		int showplayerid, bool
		show))
{
	static AMX_NATIVE native;
	cell retval;
...
SAMPGDK_NATIVE(bool, SetPlayerMapIcon(
		int playerid,
		int iconid,
		float x,
		float y,
		...
		int style))
{
	...
	cell retval;
	cell params[9];
	sampgdk_log_debug("SetPlayerMapIcon(%d, %d, %f, %f, %f, %d, %d, %d)", playerid, iconid, x, y, z, markertype, color,
	                  style);
...
SAMPGDK_NATIVE(bool, RemovePlayerMapIcon(
		int playerid,
		int iconid))
{
	static AMX_NATIVE native;
...
SAMPGDK_NATIVE(bool, AllowPlayerTeleport(
		int playerid, bool
		allow))
{
	static AMX_NATIVE native;
...
SAMPGDK_NATIVE(bool, SetPlayerCameraPos(
		int playerid,
		float x,
		float y,
		float z))
...
SAMPGDK_NATIVE(bool, SetPlayerCameraLookAt(
		int playerid,
		float x,
		float y,
		float z,
...
SAMPGDK_NATIVE(bool, SetCameraBehindPlayer(
		int playerid))
{
	static AMX_NATIVE native;
	cell retval;
...
SAMPGDK_NATIVE(bool, GetPlayerCameraPos(
		int playerid,
		float *x,
		float *y,
		float *z))
...
SAMPGDK_NATIVE(bool, GetPlayerCameraFrontVector(
		int playerid,
		float *x,
		float *y,
		float *z))
...
SAMPGDK_NATIVE(int, GetPlayerCameraMode(
		int playerid))
{
	static AMX_NATIVE native;
	cell retval;
...
SAMPGDK_NATIVE(bool, EnablePlayerCameraTarget(
		int playerid, bool
		enable))
{
	static AMX_NATIVE native;
...
SAMPGDK_NATIVE(int, GetPlayerCameraTargetObject(
		int playerid))
{
	static AMX_NATIVE native;
	cell retval;
...
SAMPGDK_NATIVE(int, GetPlayerCameraTargetVehicle(
		int playerid))
{
	static AMX_NATIVE native;
	cell retval;
...
SAMPGDK_NATIVE(int, GetPlayerCameraTargetPlayer(
		int playerid))
{
	static AMX_NATIVE native;
	cell retval;
...
SAMPGDK_NATIVE(int, GetPlayerCameraTargetActor(
		int playerid))
{
	static AMX_NATIVE native;
	cell retval;
...
SAMPGDK_NATIVE(float, GetPlayerCameraAspectRatio(
		int playerid))
{
	static AMX_NATIVE native;
	cell retval;
...
SAMPGDK_NATIVE(float, GetPlayerCameraZoom(
		int playerid))
{
	static AMX_NATIVE native;
	cell retval;
...
SAMPGDK_NATIVE(bool, AttachCameraToObject(
		int playerid,
		int objectid))
{
	static AMX_NATIVE native;
...
SAMPGDK_NATIVE(bool, AttachCameraToPlayerObject(
		int playerid,
		int playerobjectid))
{
	static AMX_NATIVE native;
...
SAMPGDK_NATIVE(bool, InterpolateCameraPos(
		int playerid,
		float FromX,
		float FromY,
		float FromZ,
		...
		int cut))
{
	...
	cell retval;
	cell params[10];
	sampgdk_log_debug("InterpolateCameraPos(%d, %f, %f, %f, %f, %f, %f, %d, %d)", playerid, FromX, FromY, FromZ, ToX,
	                  ToY, ToZ, time, cut);
...
SAMPGDK_NATIVE(bool, InterpolateCameraLookAt(
		int playerid,
		float FromX,
		float FromY,
		float FromZ,
		...
		int cut))
{
	...
	cell retval;
	cell params[10];
	sampgdk_log_debug("InterpolateCameraLookAt(%d, %f, %f, %f, %f, %f, %f, %d, %d)", playerid, FromX, FromY, FromZ, ToX,
	                  ToY, ToZ, time, cut);
...
SAMPGDK_NATIVE(bool, IsPlayerConnected(
		int playerid))
{
	static AMX_NATIVE native;
	cell retval;
...
SAMPGDK_NATIVE(bool, IsPlayerInVehicle(
		int playerid,
		int vehicleid))
{
	static AMX_NATIVE native;
...
SAMPGDK_NATIVE(bool, IsPlayerInAnyVehicle(
		int playerid))
{
	static AMX_NATIVE native;
	cell retval;
...
SAMPGDK_NATIVE(bool, IsPlayerInCheckpoint(
		int playerid))
{
	static AMX_NATIVE native;
	cell retval;
...
SAMPGDK_NATIVE(bool, IsPlayerInRaceCheckpoint(
		int playerid))
{
	static AMX_NATIVE native;
	cell retval;
...
SAMPGDK_NATIVE(bool, SetPlayerVirtualWorld(
		int playerid,
		int worldid))
{
	static AMX_NATIVE native;
...
SAMPGDK_NATIVE(int, GetPlayerVirtualWorld(
		int playerid))
{
	static AMX_NATIVE native;
	cell retval;
...
SAMPGDK_NATIVE(bool, EnableStuntBonusForPlayer(
		int playerid, bool
		enable))
{
	static AMX_NATIVE native;
...
SAMPGDK_NATIVE(bool, EnableStuntBonusForAll(bool
		enable))
{
	static AMX_NATIVE native;
	cell retval;
...
SAMPGDK_NATIVE(bool, TogglePlayerSpectating(
		int playerid, bool
		toggle))
{
	static AMX_NATIVE native;
...
SAMPGDK_NATIVE(bool, PlayerSpectatePlayer(
		int playerid,
		int targetplayerid,
		int mode))
{
...
SAMPGDK_NATIVE(bool, PlayerSpectateVehicle(
		int playerid,
		int targetvehicleid,
		int mode))
{
...
SAMPGDK_NATIVE(bool, StartRecordingPlayerData(
		int playerid,
		int recordtype,
...
SAMPGDK_NATIVE(bool, StopRecordingPlayerData(
		int playerid))
{
	static AMX_NATIVE native;
	cell retval;
...
SAMPGDK_NATIVE(bool, CreateExplosionForPlayer(
		int playerid,
		float X,
		float Y,
		float Z,
...
SAMPGDK_NATIVE(int, CreateActor(
		int modelid,
		float x,
		float y,
		float z,
...
SAMPGDK_NATIVE(bool, DestroyActor(
		int actorid))
{
	static AMX_NATIVE native;
	cell retval;
...
SAMPGDK_NATIVE(bool, IsActorStreamedIn(
		int actorid,
		int forplayerid))
{
	static AMX_NATIVE native;
...
SAMPGDK_NATIVE(bool, SetActorVirtualWorld(
		int actorid,
		int vworld))
{
	static AMX_NATIVE native;
...
SAMPGDK_NATIVE(int, GetActorVirtualWorld(
		int actorid))
{
	static AMX_NATIVE native;
	cell retval;
...
SAMPGDK_NATIVE(bool, ApplyActorAnimation(
		int actorid,
		const char *animlib,
		const char *animname,
		float fDelta, bool
		...
		int time))
{
	...
	cell animlib_;
	cell animname_;
	sampgdk_log_debug("ApplyActorAnimation(%d, \"%s\", \"%s\", %f, %d, %d, %d, %d, %d)", actorid, animlib, animname,
...
SAMPGDK_NATIVE(bool, ClearActorAnimations(
		int actorid))
{
	static AMX_NATIVE native;
	cell retval;
...
SAMPGDK_NATIVE(bool, SetActorPos(
		int actorid,
		float x,
		float y,
		float z))
...
SAMPGDK_NATIVE(bool, GetActorPos(
		int actorid,
		float *x,
		float *y,
		float *z))
...
SAMPGDK_NATIVE(bool, SetActorFacingAngle(
		int actorid,
		float angle))
{
	static AMX_NATIVE native;
...
SAMPGDK_NATIVE(bool, GetActorFacingAngle(
		int actorid,
		float *angle))
{
	static AMX_NATIVE native;
...
SAMPGDK_NATIVE(bool, SetActorHealth(
		int actorid,
		float health))
{
	static AMX_NATIVE native;
...
SAMPGDK_NATIVE(bool, GetActorHealth(
		int actorid,
		float *health))
{
	static AMX_NATIVE native;
...
SAMPGDK_NATIVE(bool, SetActorInvulnerable(
		int actorid, bool
		invulnerable))
{
	static AMX_NATIVE native;
...
SAMPGDK_NATIVE(bool, IsActorInvulnerable(
		int actorid))
{
	static AMX_NATIVE native;
	cell retval;
...
SAMPGDK_NATIVE(bool, IsValidActor(
		int actorid))
{
	static AMX_NATIVE native;
	cell retval;
...
SAMPGDK_NATIVE(bool, IsValidVehicle(
		int vehicleid))
{
	static AMX_NATIVE native;
	cell retval;
...
SAMPGDK_NATIVE(float, GetVehicleDistanceFromPoint(
		int vehicleid,
		float x,
		float y,
		float z))
...
SAMPGDK_NATIVE(int, CreateVehicle(
		int vehicletype,
		float x,
		float y,
		float z,
		...
		int color1,
		int color2,
		int respawn_delay, bool
		addsiren))
{
	static AMX_NATIVE native;
	cell retval;
	cell params[10];
	sampgdk_log_debug("CreateVehicle(%d, %f, %f, %f, %f, %d, %d, %d, %d)", vehicletype, x, y, z, rotation, color1,
...
SAMPGDK_NATIVE(bool, DestroyVehicle(
		int vehicleid))
{
	static AMX_NATIVE native;
	cell retval;
...
SAMPGDK_NATIVE(bool, IsVehicleStreamedIn(
		int vehicleid,
		int forplayerid))
{
	static AMX_NATIVE native;
...
SAMPGDK_NATIVE(bool, GetVehiclePos(
		int vehicleid,
		float *x,
		float *y,
		float *z))
...
SAMPGDK_NATIVE(bool, SetVehiclePos(
		int vehicleid,
		float x,
		float y,
		float z))
...
SAMPGDK_NATIVE(bool, GetVehicleZAngle(
		int vehicleid,
		float *z_angle))
{
	static AMX_NATIVE native;
...
SAMPGDK_NATIVE(bool, GetVehicleRotationQuat(
		int vehicleid,
		float *w,
		float *x,
		float *y,
...
SAMPGDK_NATIVE(bool, SetVehicleZAngle(
		int vehicleid,
		float z_angle))
{
	static AMX_NATIVE native;
...
SAMPGDK_NATIVE(bool, SetVehicleParamsForPlayer(
		int vehicleid,
		int playerid,
		int objective,
		int doorslocked))
...
SAMPGDK_NATIVE(bool, SetVehicleParamsEx(
		int vehicleid,
		int engine,
		int lights,
		int alarm,
		...
		int objective))
{
	...
	cell retval;
	cell params[9];
	sampgdk_log_debug("SetVehicleParamsEx(%d, %d, %d, %d, %d, %d, %d, %d)", vehicleid, engine, lights, alarm, doors,
...
SAMPGDK_NATIVE(bool, GetVehicleParamsEx(
		int vehicleid,
		int *engine,
		int *lights,
		int *alarm,
		...
		int *objective))
{
	...
	cell boot_;
	cell objective_;
	sampgdk_log_debug("GetVehicleParamsEx(%d, %d, %d, %d, %d, %d, %d, %d)", vehicleid, engine, lights, alarm, doors,
	                  bonnet, boot, objective);
...
SAMPGDK_NATIVE(int, GetVehicleParamsSirenState(
		int vehicleid))
{
	static AMX_NATIVE native;
	cell retval;
...
SAMPGDK_NATIVE(bool, SetVehicleParamsCarDoors(
		int vehicleid,
		int driver,
		int passenger,
		int backleft,
		int backright))
{
	...
	cell retval;
	cell params[6];
	sampgdk_log_debug("SetVehicleParamsCarDoors(%d, %d, %d, %d, %d)", vehicleid, driver, passenger, backleft,
	                  backright);
...
SAMPGDK_NATIVE(bool, GetVehicleParamsCarDoors(
		int vehicleid,
		int *driver,
		int *passenger,
		int *backleft,
		int *backright))
{
	...
	cell backleft_;
	cell backright_;
	sampgdk_log_debug("GetVehicleParamsCarDoors(%d, %d, %d, %d, %d)", vehicleid, driver, passenger, backleft,
	                  backright);
...
SAMPGDK_NATIVE(bool, SetVehicleParamsCarWindows(
		int vehicleid,
		int driver,
		int passenger,
		int backleft,
		int backright))
{
	...
	cell retval;
	cell params[6];
	sampgdk_log_debug("SetVehicleParamsCarWindows(%d, %d, %d, %d, %d)", vehicleid, driver, passenger, backleft,
	                  backright);
...
SAMPGDK_NATIVE(bool, GetVehicleParamsCarWindows(
		int vehicleid,
		int *driver,
		int *passenger,
		int *backleft,
		int *backright))
{
	...
	cell backleft_;
	cell backright_;
	sampgdk_log_debug("GetVehicleParamsCarWindows(%d, %d, %d, %d, %d)", vehicleid, driver, passenger, backleft,
	                  backright);
...
SAMPGDK_NATIVE(bool, SetVehicleToRespawn(
		int vehicleid))
{
	static AMX_NATIVE native;
	cell retval;
...
SAMPGDK_NATIVE(bool, LinkVehicleToInterior(
		int vehicleid,
		int interiorid))
{
	static AMX_NATIVE native;
...
SAMPGDK_NATIVE(bool, AddVehicleComponent(
		int vehicleid,
		int componentid))
{
	static AMX_NATIVE native;
...
SAMPGDK_NATIVE(bool, RemoveVehicleComponent(
		int vehicleid,
		int componentid))
{
	static AMX_NATIVE native;
...
SAMPGDK_NATIVE(bool, ChangeVehicleColor(
		int vehicleid,
		int color1,
		int color2))
{
...
SAMPGDK_NATIVE(bool, ChangeVehiclePaintjob(
		int vehicleid,
		int paintjobid))
{
	static AMX_NATIVE native;
...
SAMPGDK_NATIVE(bool, SetVehicleHealth(
		int vehicleid,
		float health))
{
	static AMX_NATIVE native;
...
SAMPGDK_NATIVE(bool, GetVehicleHealth(
		int vehicleid,
		float *health))
{
	static AMX_NATIVE native;
...
SAMPGDK_NATIVE(bool, AttachTrailerToVehicle(
		int trailerid,
		int vehicleid))
{
	static AMX_NATIVE native;
...
SAMPGDK_NATIVE(bool, DetachTrailerFromVehicle(
		int vehicleid))
{
	static AMX_NATIVE native;
	cell retval;
...
SAMPGDK_NATIVE(bool, IsTrailerAttachedToVehicle(
		int vehicleid))
{
	static AMX_NATIVE native;
	cell retval;
...
SAMPGDK_NATIVE(int, GetVehicleTrailer(
		int vehicleid))
{
	static AMX_NATIVE native;
	cell retval;
...
SAMPGDK_NATIVE(bool, SetVehicleNumberPlate(
		int vehicleid,
...
SAMPGDK_NATIVE(int, GetVehicleModel(
		int vehicleid))
{
	static AMX_NATIVE native;
	cell retval;
...
SAMPGDK_NATIVE(int, GetVehicleComponentInSlot(
		int vehicleid,
		int slot))
{
	static AMX_NATIVE native;
...
SAMPGDK_NATIVE(int, GetVehicleComponentType(
		int component))
{
	static AMX_NATIVE native;
	cell retval;
...
SAMPGDK_NATIVE(bool, RepairVehicle(
		int vehicleid))
{
	static AMX_NATIVE native;
	cell retval;
...
SAMPGDK_NATIVE(bool, GetVehicleVelocity(
		int vehicleid,
		float *X,
		float *Y,
		float *Z))
...
SAMPGDK_NATIVE(bool, SetVehicleVelocity(
		int vehicleid,
		float X,
		float Y,
		float Z))
...
SAMPGDK_NATIVE(bool, SetVehicleAngularVelocity(
		int vehicleid,
		float X,
		float Y,
		float Z))
...
SAMPGDK_NATIVE(bool, GetVehicleDamageStatus(
		int vehicleid,
		int *panels,
		int *doors,
		int *lights,
...
SAMPGDK_NATIVE(bool, UpdateVehicleDamageStatus(
		int vehicleid,
		int panels,
		int doors,
		int lights,
...
SAMPGDK_NATIVE(bool, SetVehicleVirtualWorld(
		int vehicleid,
		int worldid))
{
	static AMX_NATIVE native;
...
SAMPGDK_NATIVE(int, GetVehicleVirtualWorld(
		int vehicleid))
{
	static AMX_NATIVE native;
	cell retval;
...
SAMPGDK_NATIVE(bool, GetVehicleModelInfo(
		int model,
		int infotype,
		float *X,
		float *Y,
...
SAMPGDK_NATIVE(int, CreateObject(
		int modelid,
		float x,
		float y,
		float z,
...
SAMPGDK_NATIVE(bool, AttachObjectToVehicle(
		int objectid,
		int vehicleid,
		float fOffsetX,
		float fOffsetY,
		...
		float fRotZ))
{
	...
	cell retval;
	cell params[9];
	sampgdk_log_debug("AttachObjectToVehicle(%d, %d, %f, %f, %f, %f, %f, %f)", objectid, vehicleid, fOffsetX, fOffsetY,
	                  fOffsetZ, fRotX, fRotY, fRotZ);
...
SAMPGDK_NATIVE(bool, AttachObjectToObject(
		int objectid,
		int attachtoid,
		float fOffsetX,
		float fOffsetY,
		...
		SyncRotation))
{
	...
	cell retval;
	cell params[10];
	sampgdk_log_debug("AttachObjectToObject(%d, %d, %f, %f, %f, %f, %f, %f, %d)", objectid, attachtoid, fOffsetX,
...
SAMPGDK_NATIVE(bool, AttachObjectToPlayer(
		int objectid,
		int playerid,
		float fOffsetX,
		float fOffsetY,
		...
		float fRotZ))
{
	...
	cell retval;
	cell params[9];
	sampgdk_log_debug("AttachObjectToPlayer(%d, %d, %f, %f, %f, %f, %f, %f)", objectid, playerid, fOffsetX, fOffsetY,
	                  fOffsetZ, fRotX, fRotY, fRotZ);
...
SAMPGDK_NATIVE(bool, SetObjectPos(
		int objectid,
		float x,
		float y,
		float z))
...
SAMPGDK_NATIVE(bool, GetObjectPos(
		int objectid,
		float *x,
		float *y,
		float *z))
...
SAMPGDK_NATIVE(bool, SetObjectRot(
		int objectid,
		float rotX,
		float rotY,
		float rotZ))
...
SAMPGDK_NATIVE(bool, GetObjectRot(
		int objectid,
		float *rotX,
		float *rotY,
		float *rotZ))
...
SAMPGDK_NATIVE(int, GetObjectModel(
		int objectid))
{
	static AMX_NATIVE native;
	cell retval;
...
SAMPGDK_NATIVE(bool, SetObjectNoCameraCol(
		int objectid))
{
	static AMX_NATIVE native;
	cell retval;
...
SAMPGDK_NATIVE(bool, IsValidObject(
		int objectid))
{
	static AMX_NATIVE native;
	cell retval;
...
SAMPGDK_NATIVE(bool, DestroyObject(
		int objectid))
{
	static AMX_NATIVE native;
	cell retval;
...
SAMPGDK_NATIVE(bool, StopObject(
		int objectid))
{
	static AMX_NATIVE native;
	cell retval;
...
SAMPGDK_NATIVE(bool, IsObjectMoving(
		int objectid))
{
	static AMX_NATIVE native;
	cell retval;
...
SAMPGDK_NATIVE(bool, EditObject(
		int playerid,
		int objectid))
{
	static AMX_NATIVE native;
...
SAMPGDK_NATIVE(bool, EditPlayerObject(
		int playerid,
		int objectid))
{
	static AMX_NATIVE native;
...
SAMPGDK_NATIVE(bool, SelectObject(
		int playerid))
{
	static AMX_NATIVE native;
	cell retval;
...
SAMPGDK_NATIVE(bool, CancelEdit(
		int playerid))
{
	static AMX_NATIVE native;
	cell retval;
...
SAMPGDK_NATIVE(int, CreatePlayerObject(
		int playerid,
		int modelid,
		float x,
		float y,
		...
		float DrawDistance))
{
	...
	cell retval;
	cell params[10];
	sampgdk_log_debug("CreatePlayerObject(%d, %d, %f, %f, %f, %f, %f, %f, %f)", playerid, modelid, x, y, z, rX, rY, rZ,
	                  DrawDistance);
...
SAMPGDK_NATIVE(bool, AttachPlayerObjectToPlayer(
		int objectplayer,
		int objectid,
		int attachplayer,
		float OffsetX,
		...
		float rZ))
{
	...
	cell retval;
	cell params[10];
	sampgdk_log_debug("AttachPlayerObjectToPlayer(%d, %d, %d, %f, %f, %f, %f, %f, %f)", objectplayer, objectid,
	                  attachplayer, OffsetX, OffsetY, OffsetZ, rX, rY, rZ);
...
SAMPGDK_NATIVE(bool, AttachPlayerObjectToVehicle(
		int playerid,
		int objectid,
		int vehicleid,
		float fOffsetX,
		...
		float RotZ))
{
	...
	cell retval;
	cell params[10];
	sampgdk_log_debug("AttachPlayerObjectToVehicle(%d, %d, %d, %f, %f, %f, %f, %f, %f)", playerid, objectid, vehicleid,
	                  fOffsetX, fOffsetY, fOffsetZ, fRotX, fRotY, RotZ);
...
SAMPGDK_NATIVE(bool, SetPlayerObjectPos(
		int playerid,
		int objectid,
		float x,
		float y,
...
SAMPGDK_NATIVE(bool, GetPlayerObjectPos(
		int playerid,
		int objectid,
		float *x,
		float *y,
...
SAMPGDK_NATIVE(bool, SetPlayerObjectRot(
		int playerid,
		int objectid,
		float rotX,
		float rotY,
...
SAMPGDK_NATIVE(bool, GetPlayerObjectRot(
		int playerid,
		int objectid,
		float *rotX,
		float *rotY,
...
SAMPGDK_NATIVE(int, GetPlayerObjectModel(
		int playerid,
		int objectid))
{
	static AMX_NATIVE native;
...
SAMPGDK_NATIVE(bool, SetPlayerObjectNoCameraCol(
		int playerid,
		int objectid))
{
	static AMX_NATIVE native;
...
SAMPGDK_NATIVE(bool, IsValidPlayerObject(
		int playerid,
		int objectid))
{
	static AMX_NATIVE native;
...
SAMPGDK_NATIVE(bool, DestroyPlayerObject(
		int playerid,
		int objectid))
{
	static AMX_NATIVE native;
...
SAMPGDK_NATIVE(int, MovePlayerObject(
		int playerid,
		int objectid,
		float x,
		float y,
		...
		float RotZ))
{
	...
	cell retval;
	cell params[10];
	sampgdk_log_debug("MovePlayerObject(%d, %d, %f, %f, %f, %f, %f, %f, %f)", playerid, objectid, x, y, z, Speed, RotX,
	                  RotY, RotZ);
...
SAMPGDK_NATIVE(bool, StopPlayerObject(
		int playerid,
		int objectid))
{
	static AMX_NATIVE native;
...
SAMPGDK_NATIVE(bool, IsPlayerObjectMoving(
		int playerid,
		int objectid))
{
	static AMX_NATIVE native;
...
SAMPGDK_NATIVE(bool, SetObjectMaterial(
		int objectid,
		int materialindex,
		int modelid,
		const char *txdname,
		...
		int materialcolor))
{
	...
	cell txdname_;
	cell texturename_;
	sampgdk_log_debug("SetObjectMaterial(%d, %d, %d, \"%s\", \"%s\", %d)", objectid, materialindex, modelid, txdname,
...
SAMPGDK_NATIVE(bool, SetPlayerObjectMaterial(
		int playerid,
		int objectid,
		int materialindex,
		int modelid,
		...
		int materialcolor))
{
	...
	cell txdname_;
	cell texturename_;
	sampgdk_log_debug("SetPlayerObjectMaterial(%d, %d, %d, %d, \"%s\", \"%s\", %d)", playerid, objectid, materialindex,
...
SAMPGDK_NATIVE(bool, SetObjectMaterialText(
		int objectid,
		const char *text,
		int materialindex,
		int materialsize,
		...
		int textalignment))
{
	...
	cell text_;
	cell fontface_;
	sampgdk_log_debug("SetObjectMaterialText(%d, \"%s\", %d, %d, \"%s\", %d, %d, %d, %d, %d)", objectid, text,
	                  materialindex, materialsize, fontface, fontsize, bold, fontcolor, backcolor, textalignment);
...
SAMPGDK_NATIVE(bool, SetPlayerObjectMaterialText(
		int playerid,
		int objectid,
		const char *text,
		int materialindex,
		...
		int textalignment))
{
	...
	cell text_;
	cell fontface_;
	sampgdk_log_debug("SetPlayerObjectMaterialText(%d, %d, \"%s\", %d, %d, \"%s\", %d, %d, %d, %d, %d)", playerid,
	                  objectid, text, materialindex, materialsize, fontface, fontsize, bold, fontcolor, backcolor,
	                  textalignment);
...
SAMPGDK_NATIVE(bool, SetObjectsDefaultCameraCol(bool
		disable))
{
	static AMX_NATIVE native;
	cell retval;
...
SAMPGDK_NATIVE(int, SetTimer(
		int interval, bool
		repeat, TimerCallback
		callback,
		void *param))
{
...
SAMPGDK_NATIVE(bool, SendClientMessage(
		int playerid,
		int color,
		const char *message))
{
...
SAMPGDK_NATIVE(bool, SendClientMessageToAll(
		int color,
		const char *message))
{
	static AMX_NATIVE native;
...
SAMPGDK_NATIVE(bool, SendPlayerMessageToPlayer(
		int playerid,
		int senderid,
		const char *message))
{
...
SAMPGDK_NATIVE(bool, SendPlayerMessageToAll(
		int senderid,
		const char *message))
{
	static AMX_NATIVE native;
...
SAMPGDK_NATIVE(bool, SendDeathMessage(
		int killer,
		int killee,
		int weapon))
{
...
SAMPGDK_NATIVE(bool, SendDeathMessageToPlayer(
		int playerid,
		int killer,
		int killee,
		int weapon))
...
SAMPGDK_NATIVE(bool, GameTextForAll(
		const char *text,
		int time,
		int style))
{
...
SAMPGDK_NATIVE(bool, GameTextForPlayer(
		int playerid,
		const char *text,
		int time,
		int style))
...
SAMPGDK_NATIVE(float, VectorSize(
		float x,
		float y,
		float z))
{
...
SAMPGDK_NATIVE(bool, SHA256_PassHash(
		const char *password,
		const char *salt,
		char *ret_hash,
		int ret_hash_len))
...
SAMPGDK_NATIVE(bool, SetSVarInt(
		const char *varname,
		int int_value))
{
	static AMX_NATIVE native;
...
SAMPGDK_NATIVE(bool, SetSVarString(
		const char *varname,
...
SAMPGDK_NATIVE(bool, GetSVarString(
		const char *varname,
		char *string_return,
		int len))
{
...
SAMPGDK_NATIVE(bool, SetSVarFloat(
		const char *varname,
		float float_value))
{
	static AMX_NATIVE native;
...
SAMPGDK_NATIVE(float, GetSVarFloat(
		const char *varname))
{
	static AMX_NATIVE native;
	cell retval;
...
SAMPGDK_NATIVE(bool, DeleteSVar(
		const char *varname))
{
	static AMX_NATIVE native;
	cell retval;
...
SAMPGDK_NATIVE(bool, GetSVarNameAtIndex(
		int index,
		char *ret_varname,
		int ret_len))
{
...
SAMPGDK_NATIVE(int, GetSVarType(
		const char *varname))
{
	static AMX_NATIVE native;
	cell retval;
...
SAMPGDK_NATIVE(bool, SetGameModeText(
		const char *text))
{
	static AMX_NATIVE native;
	cell retval;
...
SAMPGDK_NATIVE(bool, SetTeamCount(
		int count))
{
	static AMX_NATIVE native;
	cell retval;
...
SAMPGDK_NATIVE(int, AddPlayerClass(
		int modelid,
		float spawn_x,
		float spawn_y,
		float spawn_z,
		...
		int weapon3_ammo))
{
	...
	cell retval;
	cell params[12];
	sampgdk_log_debug("AddPlayerClass(%d, %f, %f, %f, %f, %d, %d, %d, %d, %d, %d)", modelid, spawn_x, spawn_y, spawn_z,
	                  z_angle, weapon1, weapon1_ammo, weapon2, weapon2_ammo, weapon3, weapon3_ammo);
...
SAMPGDK_NATIVE(int, AddPlayerClassEx(
		int teamid,
		int modelid,
		float spawn_x,
		float spawn_y,
		...
		int weapon3_ammo))
{
	...
	cell retval;
	cell params[13];
	sampgdk_log_debug("AddPlayerClassEx(%d, %d, %f, %f, %f, %f, %d, %d, %d, %d, %d, %d)", teamid, modelid, spawn_x,
	                  spawn_y, spawn_z, z_angle, weapon1, weapon1_ammo, weapon2, weapon2_ammo, weapon3, weapon3_ammo);
...
SAMPGDK_NATIVE(int, AddStaticVehicle(
		int modelid,
		float spawn_x,
		float spawn_y,
		float spawn_z,
		...
		int color2))
{
	...
	cell retval;
	cell params[8];
	sampgdk_log_debug("AddStaticVehicle(%d, %f, %f, %f, %f, %d, %d)", modelid, spawn_x, spawn_y, spawn_z, z_angle,
	                  color1, color2);
...
SAMPGDK_NATIVE(int, AddStaticVehicleEx(
		int modelid,
		float spawn_x,
		float spawn_y,
		float spawn_z,
		...
		addsiren))
{
	...
	cell retval;
	cell params[10];
	sampgdk_log_debug("AddStaticVehicleEx(%d, %f, %f, %f, %f, %d, %d, %d, %d)", modelid, spawn_x, spawn_y, spawn_z,
	                  z_angle, color1, color2, respawn_delay, addsiren);
...
SAMPGDK_NATIVE(int, AddStaticPickup(
		int model,
		int type,
		float x,
		float y,
...
SAMPGDK_NATIVE(int, CreatePickup(
		int model,
		int type,
		float x,
		float y,
...
SAMPGDK_NATIVE(bool, DestroyPickup(
		int pickup))
{
	static AMX_NATIVE native;
	cell retval;
...
SAMPGDK_NATIVE(bool, ShowNameTags(bool
		show))
{
	static AMX_NATIVE native;
	cell retval;
...
SAMPGDK_NATIVE(bool, ShowPlayerMarkers(
		int mode))
{
	static AMX_NATIVE native;
	cell retval;
...
SAMPGDK_NATIVE(bool, SetWorldTime(
		int hour))
{
	static AMX_NATIVE native;
	cell retval;
...
SAMPGDK_NATIVE(bool, GetWeaponName(
		int weaponid,
		char *name,
		int size))
{
...
SAMPGDK_NATIVE(bool, EnableTirePopping(bool
		enable))
{
	static AMX_NATIVE native;
	cell retval;
...
SAMPGDK_NATIVE(bool, AllowInteriorWeapons(bool
		allow))
{
	static AMX_NATIVE native;
	cell retval;
...
SAMPGDK_NATIVE(bool, SetWeather(
		int weatherid))
{
	static AMX_NATIVE native;
	cell retval;
...
SAMPGDK_NATIVE(bool, SetGravity(
		float gravity))
{
	static AMX_NATIVE native;
	cell retval;
...
SAMPGDK_NATIVE(bool, AllowAdminTeleport(bool
		allow))
{
	static AMX_NATIVE native;
	cell retval;
...
SAMPGDK_NATIVE(bool, SetDeathDropAmount(
		int amount))
{
	static AMX_NATIVE native;
	cell retval;
...
SAMPGDK_NATIVE(bool, CreateExplosion(
		float x,
		float y,
		float z,
		int type,
...
SAMPGDK_NATIVE(bool, EnableZoneNames(bool
		enable))
{
	static AMX_NATIVE native;
	cell retval;
...
SAMPGDK_NATIVE(bool, SetNameTagDrawDistance(
		float distance))
{
	static AMX_NATIVE native;
	cell retval;
...
SAMPGDK_NATIVE(bool, LimitGlobalChatRadius(
		float chat_radius))
{
	static AMX_NATIVE native;
	cell retval;
...
SAMPGDK_NATIVE(bool, LimitPlayerMarkerRadius(
		float marker_radius))
{
	static AMX_NATIVE native;
	cell retval;
...
SAMPGDK_NATIVE(bool, ConnectNPC(
		const char *name,
		const char *script))
{
	static AMX_NATIVE native;
...
SAMPGDK_NATIVE(bool, IsPlayerNPC(
		int playerid))
{
	static AMX_NATIVE native;
	cell retval;
...
SAMPGDK_NATIVE(bool, IsPlayerAdmin(
		int playerid))
{
	static AMX_NATIVE native;
	cell retval;
...
SAMPGDK_NATIVE(bool, SendRconCommand(
		const char *command))
{
	static AMX_NATIVE native;
	cell retval;
...
SAMPGDK_NATIVE(bool, GetPlayerNetworkStats(
		int playerid,
		char *retstr,
		int size))
{
...
SAMPGDK_NATIVE(bool, GetNetworkStats(
		char *retstr,
		int size))
{
	static AMX_NATIVE native;
...
SAMPGDK_NATIVE(bool, GetPlayerVersion(
		int playerid,
		char *version,
		int len))
{
...
SAMPGDK_NATIVE(bool, BlockIpAddress(
...
SAMPGDK_NATIVE(bool, UnBlockIpAddress(
		const char *ip_address))
{
	static AMX_NATIVE native;
	cell retval;
...
SAMPGDK_NATIVE(bool, GetServerVarAsString(
		const char *varname,
		char *value,
		int size))
{
...
SAMPGDK_NATIVE(int, GetServerVarAsInt(
		const char *varname))
{
	static AMX_NATIVE native;
	cell retval;
...
SAMPGDK_NATIVE(bool, GetServerVarAsBool(
		const char *varname))
{
	static AMX_NATIVE native;
	cell retval;
...
SAMPGDK_NATIVE(bool, GetConsoleVarAsString(
		const char *varname,
		char *buffer,
		int len))
{
...
SAMPGDK_NATIVE(int, GetConsoleVarAsInt(
		const char *varname))
{
	static AMX_NATIVE native;
	cell retval;
...
SAMPGDK_NATIVE(bool, GetConsoleVarAsBool(
		const char *varname))
{
	static AMX_NATIVE native;
	cell retval;
...
SAMPGDK_NATIVE(int, NetStats_GetConnectedTime(
		int playerid))
{
	static AMX_NATIVE native;
	cell retval;
...
SAMPGDK_NATIVE(int, NetStats_MessagesReceived(
		int playerid))
{
	static AMX_NATIVE native;
	cell retval;
...
SAMPGDK_NATIVE(int, NetStats_BytesReceived(
		int playerid))
{
	static AMX_NATIVE native;
	cell retval;
...
SAMPGDK_NATIVE(int, NetStats_MessagesSent(
		int playerid))
{
	static AMX_NATIVE native;
	cell retval;
...
SAMPGDK_NATIVE(int, NetStats_BytesSent(
		int playerid))
{
	static AMX_NATIVE native;
	cell retval;
...
SAMPGDK_NATIVE(int, NetStats_MessagesRecvPerSecond(
		int playerid))
{
	static AMX_NATIVE native;
	cell retval;
...
SAMPGDK_NATIVE(float, NetStats_PacketLossPercent(
		int playerid))
{
	static AMX_NATIVE native;
	cell retval;
...
SAMPGDK_NATIVE(int, NetStats_ConnectionStatus(
		int playerid))
{
	static AMX_NATIVE native;
	cell retval;
...
SAMPGDK_NATIVE(bool, NetStats_GetIpPort(
		int playerid,
		char *ip_port,
		int ip_port_len))
{
...
SAMPGDK_NATIVE(bool, DestroyMenu(
		int menuid))
{
	static AMX_NATIVE native;
	cell retval;
...
SAMPGDK_NATIVE(int, AddMenuItem(
		int menuid,
		int column,
		const char *menutext))
{
...
SAMPGDK_NATIVE(bool, SetMenuColumnHeader(
		int menuid,
		int column,
		const char *columnheader))
{
	static AMX_NATIVE native;
	cell retval;
	cell params[4];
...
SAMPGDK_NATIVE(bool, ShowMenuForPlayer(
		int menuid,
		int playerid))
{
	static AMX_NATIVE native;
...
SAMPGDK_NATIVE(bool, HideMenuForPlayer(
		int menuid,
		int playerid))
{
	static AMX_NATIVE native;
...
SAMPGDK_NATIVE(bool, IsValidMenu(
		int menuid))
{
	static AMX_NATIVE native;
	cell retval;
...
SAMPGDK_NATIVE(bool, DisableMenu(
		int menuid))
{
	static AMX_NATIVE native;
	cell retval;
...
SAMPGDK_NATIVE(bool, DisableMenuRow(
		int menuid,
		int row))
{
	static AMX_NATIVE native;
...
SAMPGDK_NATIVE(int, GetPlayerMenu(
		int playerid))
{
	static AMX_NATIVE native;
	cell retval;
...
SAMPGDK_NATIVE(int, TextDrawCreate(
		float x,
		float y,
		const char *text))
{
...
SAMPGDK_NATIVE(bool, TextDrawDestroy(
		int text))
{
	static AMX_NATIVE native;
	cell retval;
...
SAMPGDK_NATIVE(bool, TextDrawLetterSize(
		int text,
		float x,
		float y))
{
...
SAMPGDK_NATIVE(bool, TextDrawTextSize(
		int text,
		float x,
		float y))
{
...
SAMPGDK_NATIVE(bool, TextDrawAlignment(
		int text,
		int alignment))
{
	static AMX_NATIVE native;
...
SAMPGDK_NATIVE(bool, TextDrawColor(
		int text,
		int color))
{
	static AMX_NATIVE native;
...
SAMPGDK_NATIVE(bool, TextDrawUseBox(
		int text, bool
		use))
{
	static AMX_NATIVE native;
...
SAMPGDK_NATIVE(bool, TextDrawBoxColor(
		int text,
		int color))
{
	static AMX_NATIVE native;
...
SAMPGDK_NATIVE(bool, TextDrawSetShadow(
		int text,
		int size))
{
	static AMX_NATIVE native;
...
SAMPGDK_NATIVE(bool, TextDrawSetOutline(
		int text,
		int size))
{
	static AMX_NATIVE native;
...
SAMPGDK_NATIVE(bool, TextDrawBackgroundColor(
		int text,
		int color))
{
	static AMX_NATIVE native;
...
SAMPGDK_NATIVE(bool, TextDrawFont(
		int text,
		int font))
{
	static AMX_NATIVE native;
...
SAMPGDK_NATIVE(bool, TextDrawSetProportional(
		int text, bool
		set))
{
	static AMX_NATIVE native;
...
SAMPGDK_NATIVE(bool, TextDrawSetSelectable(
		int text, bool
		set))
{
	static AMX_NATIVE native;
...
SAMPGDK_NATIVE(bool, TextDrawShowForPlayer(
		int playerid,
		int text))
{
	static AMX_NATIVE native;
...
SAMPGDK_NATIVE(bool, TextDrawHideForPlayer(
		int playerid,
		int text))
{
	static AMX_NATIVE native;
...
SAMPGDK_NATIVE(bool, TextDrawShowForAll(
		int text))
{
	static AMX_NATIVE native;
	cell retval;
...
SAMPGDK_NATIVE(bool, TextDrawHideForAll(
		int text))
{
	static AMX_NATIVE native;
	cell retval;
...
SAMPGDK_NATIVE(bool, TextDrawSetString(
		int text,
		const char *string))
{
	static AMX_NATIVE native;
...
SAMPGDK_NATIVE(bool, TextDrawSetPreviewModel(
		int text,
		int modelindex))
{
	static AMX_NATIVE native;
...
SAMPGDK_NATIVE(bool, TextDrawSetPreviewRot(
		int text,
		float fRotX,
		float fRotY,
		float fRotZ,
...
SAMPGDK_NATIVE(bool, TextDrawSetPreviewVehCol(
		int text,
		int color1,
		int color2))
{
...
SAMPGDK_NATIVE(bool, SelectTextDraw(
		int playerid,
		int hovercolor))
{
	static AMX_NATIVE native;
...
SAMPGDK_NATIVE(bool, CancelSelectTextDraw(
		int playerid))
{
	static AMX_NATIVE native;
	cell retval;
...
SAMPGDK_NATIVE(int, GangZoneCreate(
		float minx,
		float miny,
		float maxx,
		float maxy))
...
SAMPGDK_NATIVE(bool, GangZoneDestroy(
		int zone))
{
	static AMX_NATIVE native;
	cell retval;
...
SAMPGDK_NATIVE(bool, GangZoneShowForPlayer(
		int playerid,
		int zone,
		int color))
{
...
SAMPGDK_NATIVE(bool, GangZoneShowForAll(
		int zone,
		int color))
{
	static AMX_NATIVE native;
...
SAMPGDK_NATIVE(bool, GangZoneHideForPlayer(
		int playerid,
		int zone))
{
	static AMX_NATIVE native;
...
SAMPGDK_NATIVE(bool, GangZoneHideForAll(
		int zone))
{
	static AMX_NATIVE native;
	cell retval;
...
SAMPGDK_NATIVE(bool, GangZoneFlashForPlayer(
		int playerid,
		int zone,
		int flashcolor))
{
...
SAMPGDK_NATIVE(bool, GangZoneFlashForAll(
		int zone,
		int flashcolor))
{
	static AMX_NATIVE native;
...
SAMPGDK_NATIVE(bool, GangZoneStopFlashForPlayer(
		int playerid,
		int zone))
{
	static AMX_NATIVE native;
...
SAMPGDK_NATIVE(bool, GangZoneStopFlashForAll(
		int zone))
{
	static AMX_NATIVE native;
	cell retval;
...
SAMPGDK_NATIVE(int, Create3DTextLabel(
		const char *text,
		int color,
		float x,
		float y,
		...
		testLOS))
{
	...
	cell params[9];
	cell text_;
	sampgdk_log_debug("Create3DTextLabel(\"%s\", %d, %f, %f, %f, %f, %d, %d)", text, color, x, y, z, DrawDistance,
...
SAMPGDK_NATIVE(bool, Delete3DTextLabel(
		int id))
{
	static AMX_NATIVE native;
	cell retval;
...
SAMPGDK_NATIVE(bool, Attach3DTextLabelToPlayer(
		int id,
		int playerid,
		float OffsetX,
		float OffsetY,
...
SAMPGDK_NATIVE(bool, Attach3DTextLabelToVehicle(
		int id,
		int vehicleid,
		float OffsetX,
		float OffsetY,
...
SAMPGDK_NATIVE(bool, Update3DTextLabelText(
		int id,
		int color,
		const char *text))
{
...
SAMPGDK_NATIVE(int, CreatePlayer3DTextLabel(
		int playerid,
		const char *text,
		int color,
		float x,
		...
		testLOS))
{
	...
	cell params[11];
	cell text_;
	sampgdk_log_debug("CreatePlayer3DTextLabel(%d, \"%s\", %d, %f, %f, %f, %f, %d, %d, %d)", playerid, text, color, x,
	                  y, z, DrawDistance, attachedplayer, attachedvehicle, testLOS);
...
SAMPGDK_NATIVE(bool, DeletePlayer3DTextLabel(
		int playerid,
		int id))
{
	static AMX_NATIVE native;
...
SAMPGDK_NATIVE(bool, UpdatePlayer3DTextLabelText(
		int playerid,
		int id,
		int color,
		const char *text))
...
SAMPGDK_NATIVE(bool, ShowPlayerDialog(
		int playerid,
		int dialogid,
		int style,
		const char *caption,
		...
		const char *button2))
{
	...
	cell button1_;
	cell button2_;
	sampgdk_log_debug("ShowPlayerDialog(%d, %d, %d, \"%s\", \"%s\", \"%s\", \"%s\")", playerid, dialogid, style,
...
typedef bool (SAMPGDK_CALLBACK_CALL *OnUnoccupiedVehicleUpdate_callback)(int vehicleid, int playerid,
                                                                         int passenger_seat, float new_x, float new_y,
                                                                         float new_z, float vel_x, float vel_y,
                                                                         float vel_z);
...
static bool _OnUnoccupiedVehicleUpdate(AMX *amx, void *callback, cell *retval)
{
	...
	sampgdk_log_debug("OnUnoccupiedVehicleUpdate(%d, %d, %d, %f, %f, %f, %f, %f, %f)", vehicleid, playerid,
	                  passenger_seat, new_x, new_y, new_z, vel_x, vel_y, vel_z);
	retval_ = ((OnUnoccupiedVehicleUpdate_callback) callback)(vehicleid, playerid, passenger_seat, new_x, new_y, new_z,
	                                                          vel_x, vel_y, vel_z);
	if (retval != NULL)
	{
		*retval = (cell) retval_;
...
typedef bool (SAMPGDK_CALLBACK_CALL *OnPlayerInteriorChange_callback)(int playerid, int newinteriorid,
                                                                      int oldinteriorid);
...
typedef bool (SAMPGDK_CALLBACK_CALL *OnDialogResponse_callback)(int playerid, int dialogid, int response, int listitem,
...
typedef bool (SAMPGDK_CALLBACK_CALL *OnPlayerTakeDamage_callback)(int playerid, int issuerid, float amount,
...
typedef bool (SAMPGDK_CALLBACK_CALL *OnPlayerGiveDamage_callback)(int playerid, int damagedid, float amount,
                                                                  int weaponid, int bodypart);
...
typedef bool (SAMPGDK_CALLBACK_CALL *OnPlayerGiveDamageActor_callback)(int playerid, int damaged_actorid, float amount,
                                                                       int weaponid, int bodypart);
...
static bool _OnPlayerGiveDamageActor(AMX *amx, void *callback, cell *retval)
{
	...
	sampgdk_param_get_cell(amx, 3, (void *) &weaponid);
	sampgdk_param_get_cell(amx, 4, (void *) &bodypart);
	sampgdk_log_debug("OnPlayerGiveDamageActor(%d, %d, %f, %d, %d)", playerid, damaged_actorid, amount, weaponid,
	                  bodypart);
...
typedef bool (SAMPGDK_CALLBACK_CALL *OnPlayerEditObject_callback)(int playerid, bool playerobject, int objectid,
...
static bool _OnPlayerEditObject(AMX *amx, void *callback, cell *retval)
{
	...
	sampgdk_log_debug("OnPlayerEditObject(%d, %d, %d, %d, %f, %f, %f, %f, %f, %f)", playerid, playerobject, objectid,
	                  response, fX, fY, fZ, fRotX, fRotY, fRotZ);
	retval_ = ((OnPlayerEditObject_callback) callback)(playerid, playerobject, objectid, response, fX, fY, fZ, fRotX,
	                                                   fRotY, fRotZ);
	if (retval != NULL)
	{
		*retval = (cell) retval_;
...
typedef bool (SAMPGDK_CALLBACK_CALL *OnPlayerEditAttachedObject_callback)(int playerid, int response, int index,
                                                                          int modelid, int boneid, float fOffsetX,
                                                                          float fOffsetY, float fOffsetZ, float fRotX,
                                                                          float fRotY, float fRotZ, float fScaleX,
...
static bool _OnPlayerEditAttachedObject(AMX *amx, void *callback, cell *retval)
{
	...
	sampgdk_log_debug("OnPlayerEditAttachedObject(%d, %d, %d, %d, %d, %f, %f, %f, %f, %f, %f, %f, %f, %f)", playerid,
	                  response, index, modelid, boneid, fOffsetX, fOffsetY, fOffsetZ, fRotX, fRotY, fRotZ, fScaleX,
	                  fScaleY, fScaleZ);
	retval_ = ((OnPlayerEditAttachedObject_callback) callback)(playerid, response, index, modelid, boneid, fOffsetX,
	                                                           fOffsetY, fOffsetZ, fRotX, fRotY, fRotZ, fScaleX,
	                                                           fScaleY, fScaleZ);
	if (retval != NULL)
	{
		*retval = (cell) retval_;
...
typedef bool (SAMPGDK_CALLBACK_CALL *OnPlayerSelectObject_callback)(int playerid, int type, int objectid, int modelid,
...
static bool _OnPlayerSelectObject(AMX *amx, void *callback, cell *retval)
{
	...
	sampgdk_param_get_float(amx, 5, (void *) &fY);
	sampgdk_param_get_float(amx, 6, (void *) &fZ);
	sampgdk_log_debug("OnPlayerSelectObject(%d, %d, %d, %d, %f, %f, %f)", playerid, type, objectid, modelid, fX, fY,
	                  fZ);
...
typedef bool (SAMPGDK_CALLBACK_CALL *OnPlayerWeaponShot_callback)(int playerid, int weaponid, int hittype, int hitid,
                                                                  float fX, float fY, float fZ);
